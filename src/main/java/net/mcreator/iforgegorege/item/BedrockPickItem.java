...
public class BedrockPickItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 69420, 69420f, 0, 69420, TagKey.create(Registries.ITEM, ResourceLocation.parse("i_forge_gorege:bedrock_pick_repair_items")));

	public BedrockPickItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 69419f, -3.5f)
				.attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 69419, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
